<template>
    <div class="main-wrap">
        <img class="app-icon" src="~@/assets/img/toblogo.png" alt="">
  ...
  export default {
    ...
    data: () => {
      return {
        ...
        androidHref: 'https://lsfile.oss-cn-beijing.aliyuncs.com/apk/bsk_student_release.apk'
      }
    },
    methods: {
      //新加的微信分享实验
      ...
      let shareUrl = location.href
        Share.init({
          title: "博识外教伴读",
          desc: "http://www.lexislive.com.cn/lexis-activity/utils/index.html#/downloadtob",
          imgUrl: 'http://file.lexislive.com.cn/resource/201905/c69f1c82-2ae7-479d-b9e8-e8f54fb375a7.png',
          link: shareUrl
        })
